...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/media/holi/media_profiles_holi.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles.xml
    $(LOCAL_PATH)/media/holi/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_holi.xml \
